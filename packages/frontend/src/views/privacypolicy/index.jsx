      ...
      <Box>
        ...
        >
          <Box sx={{ height: "calc(100vh - 70px)", width: "90%", pt: 10 }}>
            <h1>Privacy Policy for HXMX</h1>

            <p>
              At HXMX, accessible from www.HXMX.co, one of our
              ...
              and recorded by HXMX and how we use it.
            </p>
            ...
            <p>
              HXMX follows a standard procedure of using log files. These
            ...
            <p>
              ...
              the advertising partners of HXMX.
            </p>

            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on HXMX,
            ...
            <p>
              Note that HXMX has no access to or control over these
            ...
            <p>
              HXMX&apos;s Privacy Policy does not apply to other
            ...
            <p>
              Our application, HXMX, may interact with Google services to
              ...
              Information:** HXMX may collect information, including but
              ...
              privacy policy. 4. **Sharing of Information:** HXMX does
              ...
              your use of Google services within HXMX is subject to
              ...
              handling of Google user data in HXMX, please do not
            ...
            <p>
              HXMX does not knowingly collect any Personal Identifiable
            ...
            <p>
              ...
              that they shared and/or collect in HXMX. This policy is not
