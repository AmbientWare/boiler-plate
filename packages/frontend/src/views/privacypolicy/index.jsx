      ...
      <Box>
        ...
        >
          <Box sx={{ height: "calc(100vh - 70px)", width: "90%", pt: 10 }}>
            <h1>Privacy Policy for AmbientWare</h1>

            <p>
              At AmbientWare, accessible from www.ambientware.co, one of our
              ...
              and recorded by AmbientWare and how we use it.
            </p>
            ...
            <p>
              AmbientWare follows a standard procedure of using log files. These
            ...
            <p>
              ...
              the advertising partners of AmbientWare.
            </p>

            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on AmbientWare,
            ...
            <p>
              Note that AmbientWare has no access to or control over these
            ...
            <p>
              AmbientWare&apos;s Privacy Policy does not apply to other
            ...
            <p>
              Our application, AmbientWare, may interact with Google services to
              ...
              Information:** AmbientWare may collect information, including but
              ...
              privacy policy. 4. **Sharing of Information:** AmbientWare does
              ...
              your use of Google services within AmbientWare is subject to
              ...
              handling of Google user data in AmbientWare, please do not
            ...
            <p>
              AmbientWare does not knowingly collect any Personal Identifiable
            ...
            <p>
              ...
              that they shared and/or collect in AmbientWare. This policy is not
